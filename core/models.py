...
class Fabricante(models.Model):
    ...
    logo = models.ImageField(upload_to='logo_fabricante', blank=True, null=True, verbose_name="")
...
class Rotativo(models.Model):
    ...
    id_veiculo = models.ForeignKey(Veiculo, on_delete=models.CASCADE, verbose_name='Veiculos')
    id_tabela = models.ForeignKey(TabelaPreco, on_delete=models.CASCADE, verbose_name='Preço')
    ...
    def __str__(self):
        return f'{self.data_hora_entrada}-{self.id_veiculo}'
    ...
    def calcular_total(self):
        if self.data_hora_saida:
            ...
            if hora > 0.5:
                ...
                self.total = (math.ceil(hora) * obj.valor) / 2
            return self.total
        else:
            return 0.0
